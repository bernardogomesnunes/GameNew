...
// is selected.
export const BLOCKS = [
  { id: 1, name: 'Grass', glyph: 'grass', color: 0x5b9c3f, soil: true, material: 'dirt', cost: { wood: 1 }, unlock: null },
  { id: 2, name: 'Dirt', glyph: 'dirt', color: 0x7a5230, soil: true, material: 'dirt', cost: { wood: 1 }, unlock: null },
  { id: 3, name: 'Stone', glyph: 'stone', color: 0x8a8a8d, material: 'stone', cost: { stone: 1 }, unlock: null },
  { id: 4, name: 'Wood', glyph: 'log', color: 0x8a5a2b, material: 'wood', cost: { wood: 2 }, unlock: null },
  ...
  { id: 5, name: 'Leaves', glyph: 'leaf', color: 0x3f7d34, material: 'plant', cost: { wood: 1 }, unlock: null },
  { id: 6, name: 'Sand', glyph: 'sand', color: 0xdcc57a, material: 'dirt', cost: { wood: 1 }, unlock: null },
  { id: 7, name: 'Planks', glyph: 'planks', color: 0xb98a4b, material: 'wood', cost: { wood: 1 }, unlock: null },
  { id: 8, name: 'Cobblestone', glyph: 'cobble', color: 0x6b6b6e, material: 'stone', cost: { stone: 1 }, unlock: null },
  { id: 9, name: 'Brick', glyph: 'brick', color: 0xa8422f, material: 'stone', cost: { brick: 1 }, unlock: null },
  ...
  { id: 13, name: 'Gold Block', glyph: 'gold', color: 0xf4c542, material: 'stone', cost: { gold: 1 }, unlock: { type: 'level', value: 6 } },
  { id: 14, name: 'Obsidian', glyph: 'obsidian', color: 0x1c1424, material: 'stone', cost: { stone: 4 }, unlock: { type: 'achievement', value: 'underground' } },
  ...
  { id: 17, name: 'Marble', glyph: 'marble', color: 0xe9e6de, material: 'stone', cost: { stone: 3 }, unlock: { type: 'achievement', value: 'architect' } },
  ...
  { id: 20, name: 'Sapling', glyph: 'sprout', color: 0x6aa84f, material: 'plant', cost: { wood: 1 }, unlock: null },
  { id: 21, name: 'Farmland', glyph: 'farmland', color: 0x6b4a2a, material: 'dirt', cost: { wood: 1 }, unlock: null },
  ...
  { id: 22, name: 'Moss', glyph: 'moss', color: 0x3c6b31, soil: true, material: 'dirt', unlock: null },
  { id: 23, name: 'Gravel', glyph: 'gravel', color: 0x9a948a, material: 'stone', unlock: null },
  { id: 24, name: 'Clay', glyph: 'clay', color: 0x8d9aa0, soil: true, material: 'dirt', unlock: null },
];
